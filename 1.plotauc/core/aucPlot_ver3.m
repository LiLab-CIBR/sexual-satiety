function aucPlot_ver3(result_folder, load_neuron, load_auc, Fs, gender, thresh,intruder_label,trace_per_plot,double_thresh,first_event,second_event, auc_thresh)
