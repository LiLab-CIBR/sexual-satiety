function aucPlot_ver1(result_folder, load_neuron, load_auc, Fs, gender, thresh,intruder_label,trace_per_plot,double_thresh,first_event,second_event, auc_thresh)
...
% dec_seg_ind = {1:10};
% dec_data = mean_trace;
plot_data(dec_data,neuron,dec_seg_ind,'deconv','plot_thresh',thresh,'zeroline','save_path',result_folder)
% 
...
if ~exist('auc_result1','var') || ~load_auc
    auc_result1 = auc_cue(dec_data,sig_data,neuron,auc_thresh(1),result_folder,filelist,'light_on');
    plot_data(dec_data,neuron,dec_seg_ind,'auc',auc_result1,'zeroline','zero_blank');
end
...
if ~exist('auc_result2','var') || ~load_auc
    auc_result2 = auc_cue(dec_data,sig_data,neuron,auc_thresh(2),result_folder,filelist,'light_on');
    plot_data(dec_data,neuron,dec_seg_ind,'auc',auc_result2,'zeroline','zero_blank');
end
