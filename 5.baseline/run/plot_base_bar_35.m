...
basebar.datelist.recovery1 = {'Esr2220621','Esr2290705','Esr2300721','Esr2520316','Esr290323'};
basebar.datelist.satiated2 = {'Esr2220626','Esr2290708','Esr2300629','Esr2520318',''};
...
basebar.gender = 'male';
%状态
basebar.clusterlist = {'virgin1','virgin2','recovery1','satiated2','recovery2'};%
%三级目录名称（用到的天数）
basebar.datelist.virgin1 = {'Esr2220511','Esr2290607','Esr2300622','Esr2520214','Esr290201'};
basebar.datelist.virgin2 = {'Esr2220514','Esr2290616','Esr2300626','Esr2520221','Esr290203'};
% basebar.datelist.nearly = {'Esr2220515','Esr2290623'};
...
basebar.gender = 'male';
%状态
basebar.clusterlist = {'virgin1','recovery1','satiated2','recovery2'};%
%三级目录名称（用到的天数）
basebar.datelist.virgin1 = {'Esr2220511','Esr2290607','Esr2300622','Esr2520214'};
basebar.datelist.recovery1 = {'Esr2220621','Esr2290705','Esr2300721','Esr2520316'};
basebar.datelist.satiated2 = {'Esr2220626','Esr2290708','Esr2300629','Esr2520318'};
basebar.datelist.recovery2 = {'Esr2220625','Esr2290816','Esr2300817','Esr2520210'};
%以动物为单位还是以细胞为单位
basebar.minunit = 'animal';%'animal','neuron'
...
%三级目录名称（用到的天数）
basebar.datelist.virgin = {'Esr240109','Esr2401214','Esr2371214','Esr2540216','Esr2350218'};%'Esr2370215',
...
basebar.clusterlist = {'virgin1','virgin2'};
%三级目录名称（用到的天数）
basebar.datelist.virgin1 = {'Esr240109','Esr2401213','Esr2371214','Esr2540216','Esr2350215'};%,'Esr2370215'
basebar.datelist.virgin2 = {'Esr240112','Esr2401214','Esr2371227','Esr2540218','Esr2350218'};%,'Esr2370216'
%以动物为单位还是以细胞为单位
basebar.minunit = 'animal';%'animal','neuron'
basebar.isnormalize = true;
base_bar_core(basebar)
