function Copy_of_PlotBehBar(behbar)
...
draw_beh_bar(savedir,name,'mount latency',clusterlist,mount_latency2,is_ttest_only,is_paired_ttest,ttest_group,1800)
%% 2.cons duration
draw_beh_bar(savedir,name,'cons duration',clusterlist,cons_length,is_ttest_only,is_paired_ttest,ttest_group,3000)
%% 3.intro counts
draw_beh_bar(savedir,name,'intro counts',clusterlist,intro_counts,is_ttest_only,is_paired_ttest,ttest_group,80)
%% 4.appe sniff duration % 
draw_beh_bar(savedir,name,['sniff dur in appe or',num2str(timewindow)],clusterlist,sniff_appe_dur_percent,is_ttest_only,is_paired_ttest,ttest_group,100)
%% 5. % mount+intro dur/cons dur
draw_beh_bar(savedir,name,'mount+intro dur in cons',clusterlist,mi_cons_dur_percent,is_ttest_only,is_paired_ttest,ttest_group,100)
%% 6. mean intro interval dur
draw_beh_bar(savedir,name,'mean intro interval dur',clusterlist,intro_inter_dur,is_ttest_only,is_paired_ttest,ttest_group,300)
%% 7.mount counts
draw_beh_bar(savedir,name,'mount counts',clusterlist,mount_counts,is_ttest_only,is_paired_ttest,ttest_group,100)
%% 8. mount freq
draw_beh_bar(savedir,name,'mount frequency',clusterlist,mount_freq,is_ttest_only,is_paired_ttest,ttest_group,0.1)
%% 9. intro freq
...
%% 1.lordosis counts v
draw_beh_bar(savedir,name,['lordosis trials in ',num2str(timewindow)],clusterlist,intro_percent,is_ttest_only,is_paired_ttest,ttest_group,1)
%% 2.reject counts v
draw_beh_bar(savedir,name,['reject trials in ',num2str(timewindow)],clusterlist,reject_percent,is_ttest_only,is_paired_ttest,ttest_group,1)
%% 3.cons lordosis length %
draw_beh_bar(savedir,name,['lordosis dur in ',num2str(timewindow)],clusterlist,lordo_cons_dur_percent,is_ttest_only,is_paired_ttest,ttest_group,1)
%% 5. % mount+intro dur/cons dur
draw_beh_bar(savedir,name,'mount_intro dur in cons',clusterlist,mi_cons_dur_percent,is_ttest_only,is_paired_ttest,ttest_group,1)
%% 6. intro interval dur
draw_beh_bar(savedir,name,'mean intro dur',clusterlist,intro_inter_dur,is_ttest_only,is_paired_ttest,ttest_group,600)
