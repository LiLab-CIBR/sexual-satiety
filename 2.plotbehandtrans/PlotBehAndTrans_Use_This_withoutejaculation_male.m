...
% clusterlist = {'cons','control'};
% excel_folder = 'E:\wupeixuan\auc_plot\data\dzyimg\miniscope data plot\Figure1-3\fig1data\optogenetic_0228\control_con';
% name = 'with ejaculation female';
% gender = 'female';

%W ej female
% clusterlist = {'wo day1-1','wo day1-2','w-Ves- day1-1','w-Ves- day1-2','w-WT-day1-1','w-WT- day1-2'};
% excel_folder = 'E:\wupeixuan\auc_plot\data\dzyimg\miniscope data plot\Figure1-3\fig1data\behavior test-zxj-0414';
% name = 'behavior test-zxj-0414';
% gender = 'female';

% %W/o ej female 4di
% clusterlist = {'pretest-control','pretest-CNO','test-control','test-CNO','posttest-control','posttest-CNO',};
% excel_folder = 'E:\wupeixuan\auc_plot\data\dzyimg\miniscope data plot\Figure1-3\fig1data\Fe_Esr2_hM4Di';
% name = 'Fe_Esr2_hM4Di';
% gender = 'female';
...
%W/O ej male
clusterlist = {'day1','day2','day3','day7'};
...
beh.name = name;
%要改的
beh.isdivide = true;%是不是画分行
%beh.behaviorlist = {'passive','mount','introm','flee','sitting','ejacu'};%目前上限7个，第一个是sniff，最后一个是ejaculation
beh.behaviorlist = {'positive','mount','introm','ejacu'};%目前上限7个，第一个是sniff，最后一个是ejaculation
...
%要改的
behbar.timewindow = 10;%分钟,这里只有female会用到
behbar.savedir = 'E:\wupeixuan\auc_plot\data\dzyimg\miniscope data plot\Figure1-3\fig1pic\ZXJ_used_20220226\without ejaculation male\0414';%自己改
%behbar.savedir = 'E:\wupeixuan\auc_plot\data\dzyimg\miniscope data plot\Figure1-3\fig1pic\ZXJ_used_20220226\with ejaculation female\0412 ves\new';%自己改
%behbar.savedir = 'E:\wupeixuan\auc_plot\data\dzyimg\miniscope data plot\Figure1-3\fig1pic\ZXJ_used_20220226\Fe_Esr2_hM4Di';%自己改
% behbar.savedir = 'E:\wupeixuan\auc_plot\data\dzyimg\miniscope data plot\Figure1-3\fig1pic\ZXJ_used_20220226\with ejaculation female';%自己改
%behbar.savedir = 'E:\wupeixuan\auc_plot\data\dzyimg\miniscope data plot\Figure1-3\fig1pic\ZXJ_used_20220226\opto_0303\0406 control&con\0407\new';%自己改
%behbar.savedir = 'E:\wupeixuan\auc_plot\data\dzyimg\miniscope data plot\Figure1-3\fig1pic\ZXJ_used_20220226\opto_0303\0407control_app';%自己改
%behbar.savedir = 'E:\wupeixuan\auc_plot\data\dzyimg\miniscope data plot\Figure1-3\fig1pic\ZXJ_used_20220226\without ejaculation female';%自己改
%跑这一步
PlotBehBar(behbar);
...
transition.constimecuttranslist = {{'mount','introm'}};%from在前to在后

transition.timewindow = 10;%分钟,计算第一个行为之后？时间的transition
transition.timecuttranslist = {{'positive','mount'}};%from在前to在后
transition.savedir = 'E:\wupeixuan\auc_plot\data\dzyimg\miniscope data plot\Figure1-3\fig1pic\ZXJ_used_20220226\without ejaculation male\0414';%自己改
...
transbar.savedir = 'E:\wupeixuan\auc_plot\data\dzyimg\miniscope data plot\Figure1-3\fig1pic\ZXJ_used_20220226\without ejaculation male\0414';%自己改
