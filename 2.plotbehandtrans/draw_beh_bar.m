function draw_beh_bar(savedir,name,savename,clusterlist,inputvar,is_ttest_only,is_paired_ttest,ttest_group,ylength)
...
saveas(gcf,[savedir,'\fig1_bar_',name,'_',savename,'.pdf']);
