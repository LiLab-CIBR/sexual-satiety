function draw_beh_bar_and_output_data(savedir,name,savename,clusterlist,inputvar,is_ttest_only,is_paired_ttest,ttest_group,ylength)
...
saveas(gcf,[savedir,'\picfile\fig1_bar_',name,'_',savename,'.pdf']);
